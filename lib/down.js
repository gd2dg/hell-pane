...
export default class downer {
    ...
    init(word) {
        ...
        this.rootDictUrl = 'https://www.youdict.com'
        this.toeflUrl = 'https://www.youdict.com/tags/TOEFL'
        this.phoneticUrl = 'https://dict.youdao.com/dictvoice?type=0&audio=${querystring.escape(word)}'
        this.newconceptUrl = 'https://www.hxen.com/englishlistening/xingainian/kewen3/2014-05-13/347585.html'
    }
        ...
        try {
            ...
            if(direct){
                ...
                var winnerPromise = new Promise(function (res) {
                    setTimeout(function () { res('timeout') }, 20000);
                });
