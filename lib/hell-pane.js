...
import * as Htail from './htail';
import HaiDict from './haidict';
import CgDict from './cgdict';
    ...
    activate(state) {
        ...
        this.subscriptions = new CompositeDisposable(
            ...
            atom.commands.add('atom-workspace', {
                ...
                'hell-pane:save_head': () => Htail.save_head(),
                'hell-pane:set_head': () => Htail.set_head(),
                'hell-pane:fill_note': () => Htail.fill_note(),
                // %%
