...
var app_id = "7f9670cd";
var app_key = "b01d80189909bcfafbd0103e29d17af8";
...
dict.find("hello",function(error,data){
    ...
    var root = `C:\\Users\\gz1305\\Desktop\\youdao`
    var inputFile = `${root}/dict.json`;
    fs.writeFileSync(outputFile, data);
});

// to find a list of world
// {
//     "metadata": {
...
//                     "registers": ["informal"],
//                     "subsenses": [{
//                         "definitions": ["score an ace on (a hole) or with (a shot):"],
//                         "domains": ["Golf"],
//                         "examples": [{
...
//                     "registers": ["informal"],
//                     "subsenses": [{
//                         "definitions": ["outdo someone in a competitive situation:"],
//                         "examples": [{
